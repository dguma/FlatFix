...
router.post('/apply', authenticateToken, validate(applicationSchema), async (req, res) => {
  try {
    ...
    // Build application from user profile + provided optional fields
    const app = new TechApplication({
